...
public:
    ...
    void setupUi(QMainWindow *MyWindow)
    {
        ...
        MyWindow->resize(800, 327);
        centralwidget = new QWidget(MyWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(190, 10, 131, 21));
        QFont font;
        ...
        lineEditMotDePasse->setGeometry(QRect(308, 10, 113, 25));
        ...
        lineEditNom->setGeometry(QRect(68, 10, 113, 25));
        ...
        pushButtonLogout->setGeometry(QRect(530, 10, 91, 25));
        ...
        pushButtonLogin->setGeometry(QRect(430, 10, 91, 25));
        ...
        checkBoxNouveauClient->setGeometry(QRect(630, 10, 151, 23));
    ...
    {
        MyWindow->setWindowTitle(QApplication::translate("MyWindow", "Gestion d'un fichier binaire de clients", nullptr));
        ...
        checkBoxNouveauClient->setText(QApplication::translate("MyWindow", "Nouveau client", nullptr));
