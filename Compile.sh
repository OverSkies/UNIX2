...
g++  -o UNIX_Exercice2 main.o mywindow.o moc_mywindow.o FichierClient.o /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Core.so /usr/lib64/libGL.so -lpthread